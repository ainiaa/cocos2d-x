...
bool AppDelegate::initInstance() {
	...
	do {
		...
		// OpenGLView initialized in HelloXBrick/android/jni/helloworld/main.cpp
		...
		cocos2d::CCFileUtils::setResource("HelloXBrick.zip");
#endif
		...
		CCEGLView * pMainWnd = new CCEGLView();
		CC_BREAK_IF(! pMainWnd
				|| ! pMainWnd->Create("cocos2d: Hello XBrick", 800, 480,480, 320));
...
//     pDirector->enableRetinaDisplay(true);
	...
	CCScene *pScene = HelloXBrick::scene();
